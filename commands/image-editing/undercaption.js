...
class UnderCaptionCommand extends ImageCommand {
  params(url) {
    ...
    return {
      caption: newCaption,
      fontfile: "Determination Sans Web",
      invert: true
    };
  }

  static description = "Adds a caption to an image";
  static aliases = ["undertalecaption", "undercap"];
...
export default UnderCaptionCommand;